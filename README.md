...
개인 브라우저에 저장됩니다. ‘저장과 동기화’에서 모든 형식을 오프라인으로 준비하고, 책장의 백업 메뉴에서
ZIP을 보관할 수 있습니다. 초기 화면만 먼저 받고, 사용한 형식은 자동 캐시하며 전체 오프라인 선택은
업데이트에도 유지합니다. 저장 보호 요청·일주일 백업 안내·작업 중 업데이트 보호도 제공합니다.
