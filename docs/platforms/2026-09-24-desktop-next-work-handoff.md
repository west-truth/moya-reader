...
작성: 2026-09-24. 초기 코드 확인 기준: `d537b26`. 현재 수집기 검증 기준: `775a9ff`, 실제 앱 검증 기준: `48b62c5`. **다음 작업은 D2b 기존 작품 원본 교체·나머지 변경 동기화, B의 남은 장애 경계와 대용량 복제 검증이다.** 이 문서는 기존 구현 계획을 실행 단위로 구체화한다. 제품 구현을 완료했다는 기록이 아니다.
