...
작성: 2026-09-23. 상태: **계획 재작성 완료, 내장 서버 구현 미착수**.
...
- [ ] P0의 Windows 실행 구성 비교 및 실제 사용 흐름 검증.
- [ ] P1 접속 가능한 앱.
- [ ] P2 주요 기능 연결·이전·데이터 보호.
- [ ] P3 동기화·간편 접속.

이번 변경은 브랜치 분리와 문서 재작성이다. 새 내장 서버 구현은 시작하지 않았다. 기존 Docker 운영 서비스와 다른 작업자의 변경은 이 작업에서 수정하지 않았다.
